{{-- resources/views/finance/chart_accounts/create.blade.php --}}
<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">
                    Create a new account for your finance module
                </p>
            </div>
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-green-50">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-sm text-gray-500">Fill in the details below to create a new account</p>
                        </div>
                    </div>
                </div>

                {{-- Form Content --}}
                <form method="POST" action="{{ url('/finance/chart_of_accounts') }}" class="p-6 space-y-6">
                    @csrf
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-xs text-gray-500">Unique code for the account (recommended numeric)</p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="text-xs text-gray-500">Controls Balance Sheet / P&L mapping</p>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <select id="parent_id" name="parent_id"
                                    ...
                                    {{-- If you pass $parents from controller --}}
                                    @isset($parents)
                            ...
                            <p class="text-xs text-gray-500">Use for sub-accounts (grouping)</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-xs text-gray-500">Inactive accounts will not appear in vouchers</p>
                    </div>
            ...
            <div class="mt-6 bg-gradient-to-br from-green-50 to-emerald-50 border border-green-100 rounded-xl p-5">
                <div class="flex items-start">
                    ...
                    <div class="ml-3">
                        <h3 class="text-sm font-medium text-green-800">Tips for Chart of Accounts</h3>
                        <div class="mt-2 text-sm text-green-700">
                            <ul class="list-disc pl-5 space-y-1">
                                <li>Use a consistent numbering system (1000 Assets, 2000 Liabilities, etc.)</li>
                                <li>Use Parent Accounts for grouping (e.g., Cash & Bank → Cash in Hand)</li>
                                <li>Keep accounts clean: don’t mix Income and Expense types</li>
                                <li>Deactivate accounts instead of deleting (to protect audit trail)</li>
                            </ul>
                        </div>
                    </div>
                </div>
