    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Record a new journal voucher with debit and credit entries</p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="px-6 py-5 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-gray-900">New Journal Voucher</h3>
                            <p class="text-sm text-gray-600">Complete the form below to create a new journal entry</p>
                        </div>
                    </div>
                </div>

                <form method="POST" action="{{ url('/finance/journal_entries') }}" class="p-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <input name="journal_no" value="{{ old('journal_no', $JournalEntryNo) }}"
                            ...
                            <p class="text-xs text-gray-500">Automatically generated journal number</p>
                        </div>
                    ...
                    <div class="mb-8 rounded-xl border border-gray-200 p-5 bg-gradient-to-br from-gray-50 to-white">
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Add debit and credit entries for this journal</p>
                            </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody id="linesBody" class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td class="px-4 py-3">
                                            <select name="lines[0][cr_account_id]"
                                        ...
                                        <td class="px-4 py-3">
                                            <select name="lines[0][dr_account_id]"
                                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                                                    required>
                                                <option value="">-- Select Account --</option>
                                                @foreach($accounts as $a)
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="relative">
                                                <input type="number" step="0.01" min="0.01"
                                                       name="lines[0][amount]"
                                                       class="w-full px-3 py-2 pl-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors text-right placeholder-gray-400 amount"
                    ...
                    <div class="mb-8">
                        <div class="space-y-2">
                            ...
                            <textarea name="remark"
                                      ...
                                      rows="3"
                                      placeholder="Enter any additional remarks or notes about this journal entry">{{ old('remark') }}</textarea>
