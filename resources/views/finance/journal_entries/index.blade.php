    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Manage financial journal vouchers and transactions</p>
            </div>
            <a href="{{ url('/finance/journal_entries/create') }}"
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Create new journal entries or manage existing ones</p>
                        </div>
                    </div>
                    <div>
                        <a href="{{ url('/finance/journal_entries/create') }}"
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div>
                            <h3 class="text-lg font-bold text-gray-900">Journal Vouchers</h3>
                            <p class="text-sm text-gray-600">{{ $entries->total() }} journal entries found</p>
                        </div>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors group">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                <div class="text-sm font-semibold text-gray-900">{{ $e->journal_no }}</div>
                                    ...
                                    <!-- Voucher Date Column -->
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ $e->voucher_date }}</div>
                                        <div class="text-xs text-gray-500">
                                            {{ \Carbon\Carbon::parse($e->voucher_date)->diffForHumans() }}
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center space-x-2">
                                            <a href="{{ url('/finance/journal_entries/'.$e->id) }}"
                                            ...
                                            <a href="{{ url('/finance/journal_entries/'.$e->id.'/edit') }}"
                                            ...
                                            <form method="POST" action="{{ url('/finance/journal_entries/'.$e->id) }}" class="inline">
                                                @csrf @method('DELETE')
                                                <button type="submit"
                                ...
                                <tr>
                                    <td colspan="5" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <h3 class="text-lg font-medium text-gray-900 mb-1">No Journal Entries Found</h3>
