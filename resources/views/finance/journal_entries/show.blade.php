<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 no-print">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Journal Entry Details</h1>
                <div class="flex items-center gap-2 mt-1">
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-indigo-100 text-indigo-800">
                        {{ $entry->journal_no }}
                    </span>
                    <span class="text-sm text-gray-600">
                        {{ \Carbon\Carbon::parse($entry->voucher_date)->format('M d, Y') }}
                    </span>
                </div>
            </div>
            ...
            <div id="printArea">
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 print-container">
                    ...
                    <div class="mb-8 text-center print-header">
                        <h1 class="text-2xl font-bold text-gray-900 mb-1">JOURNAL VOUCHER</h1>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        ...
                        <div class="bg-gradient-to-br from-blue-50 to-white rounded-xl p-5 border border-blue-100">
                            <div class="flex items-center mb-4">
                                ...
                                <h3 class="text-lg font-semibold text-gray-900">Journal Details</h3>
                            </div>
                            <div class="space-y-3">
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-600">Journal No:</span>
                                    <span class="text-sm font-medium text-gray-900">{{ $entry->journal_no }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-600">Voucher Date:</span>
                                    <span class="text-sm font-medium text-gray-900">{{ $entry->voucher_date }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gradient-to-br from-green-50 to-white rounded-xl p-5 border border-green-100">
                            <div class="flex items-center mb-4">
                                ...
                                <h3 class="text-lg font-semibold text-gray-900">Amount Summary</h3>
                            </div>
                            <div class="space-y-3">
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-600">Total Amount:</span>
                                    <span class="text-lg font-bold text-gray-900">₹{{ number_format($entry->total_amount, 2) }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-600">Entries Count:</span>
                                    <span class="text-sm font-medium text-gray-900">{{ $entry->lines->count() }} entries</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                                            <span class="text-green-600">CR Account</span>
                                        </th>
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                                            <span class="text-red-600">DR Account</span>
                                        </th>
                                    ...
                                    @foreach($entry->lines as $l)
                                        <tr class="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td class="px-6 py-4 text-sm text-gray-500">
                                                {{ optional($l->crAccount)->account_name ?? '—' }}
                                            </td>
                                            <td class="px-6 py-4 text-sm text-gray-500">
