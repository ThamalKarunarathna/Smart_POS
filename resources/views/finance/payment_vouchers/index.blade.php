                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Create new payment vouchers or manage existing ones</p>
                        </div>
                    </div>
                    <div>
                        <a href="{{ url('/finance/payment_vouchers/create') }}"
                ...
                <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        ...
                        <div class="text-sm text-gray-500">
                            Showing {{ $vouchers->firstItem() ?? 0 }}-{{ $vouchers->lastItem() ?? 0 }} of {{ $vouchers->total() }}
                        </div>
                    </div>
                </div>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors group">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                <div class="text-sm font-semibold text-gray-900">{{ $v->voucher_no }}</div>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @php
                                            $statusColors = [
                                                ...
                                                'paid' => ['bg' => 'bg-blue-100', 'text' => 'text-blue-800', 'icon' => 'M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z'],
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <a href="{{ url('/finance/payment_vouchers/'.$v->id) }}"
                                            ...
                                            <a href="{{ url('/finance/payment_vouchers/'.$v->id.'/edit') }}"
                                               class="inline-flex items-center px-3 py-1.5 border border-blue-300 rounded-lg text-sm font-medium text-blue-700 bg-blue-50 hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
                                               title="Edit">
                                                <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <form method="POST" action="{{ url('/finance/payment_vouchers/'.$v->id) }}" class="inline">
                                                @csrf @method('DELETE')
                                                <button type="submit"
                                                        class="inline-flex items-center px-3 py-1.5 border border-red-300 rounded-lg text-sm font-medium text-red-700 bg-red-50 hover:bg-red-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors"
                                                        onclick="return confirm('Are you sure you want to delete this payment voucher? This action cannot be undone.')"
                                                        title="Delete">
                                                    <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <tr>
                                    <td colspan="5" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <h3 class="text-lg font-medium text-gray-900 mb-1">No Payment Vouchers Found</h3>
                                            <p class="text-sm text-gray-500 mb-4">Get started by creating your first payment voucher</p>
                                            <a href="{{ url('/finance/payment_vouchers/create') }}"
