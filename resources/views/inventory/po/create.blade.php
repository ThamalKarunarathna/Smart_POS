                ...
                <div class="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-indigo-50">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-sm text-gray-500">Fill in supplier information and items</p>
                        </div>
                    </div>
                </div>

                <form method="POST" action="{{ route('po.store') }}" class="p-6">
                    @csrf
                    ...
                    <div class="border border-gray-200 rounded-lg p-5 bg-gradient-to-br from-gray-50 to-indigo-50">
                        <div class="flex justify-between items-center mb-4">
                            <div>
                                ...
                                <p class="text-sm text-gray-500">Add items to this purchase order</p>
                            </div>
                            <button type="button"
                                    id="addRow"
                            ...
                            <table class="min-w-full border border-gray-200 rounded-lg overflow-hidden" id="itemsTable">
                                ...
                                <tbody>
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td class="border-b px-4 py-3">
                                            <input type="text"
                                                   class="line_total w-full border-gray-300 rounded-lg px-3 py-2 bg-gray-50"
                                                   value="0.00" readonly>
                                        </td>
                                        <td class="border-b px-4 py-3">
                                            <button type="button"
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            addRowBtn.addEventListener('click', () => {
                ...
                tr.innerHTML = `
                    ...
                    <td class="border-b px-4 py-3">
                        <input type="text" class="line_total w-full border-gray-300 rounded-lg px-3 py-2 bg-gray-50" value="0.00" readonly>
                    </td>
                    <td class="border-b px-4 py-3">
                        <button type="button"
                                class="removeRow inline-flex items-center p-2 text-red-600 hover:text-red-700 hover:bg-red-50 rounded-lg transition-colors">
