...
<body class="font-sans antialiased bg-gray-50" x-data="{ inventoryOpen: false, financeOpen: false, reportopen: false, billingOpen: false }">
    <div class="min-h-screen flex" x-data x-bind:class="$store.sidebar.collapsed ? 'lg:pl-30' : 'lg:pl-64'">
        ...
        {{-- Sidebar --}}
        <aside
            class="fixed inset-y-0 left-0 z-50 flex flex-col bg-white border-r border-gray-200 shadow-lg sidebar-transition"
            :class="$store.sidebar.width">

            {{-- Logo Area --}}
            <div class="h-16 flex items-center px-4 border-b border-gray-100">
                <a href="{{ route('dashboard') }}" class="flex items-center gap-2 font-semibold text-gray-800 min-w-0">
            ...
            <button @click="$store.sidebar.toggle()"
                ...
                <svg class="w-4 h-4 text-gray-600 transition-transform duration-300"
                    :class="$store.sidebar.iconRotation" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
                ...
                @if (auth()->check() && auth()->user()->role === 'admin')
                   ...
                   :class="request()->is('pos/orders*') ? 'bg-blue-50 text-blue-600 font-medium' : ''">
                    ...
                    <div>
                        <button type="button" @click="billingOpen = !billingOpen"
                            ...
                            <svg class="w-4 h-4 ml-auto flex-shrink-0 transform transition"
                                :class="billingOpen ? 'rotate-180' : ''" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 9l-7 7-7-7" />
                            </svg>
                        ...
                        <div x-show="billingOpen" x-collapse class="mt-1 space-y-1 overflow-hidden">
                            <a href="{{ url('/pos/orders') }}"
                    ...
                    <a href="{{ url('/customers') }}"
                        ...
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5 1.195a9.003 9.003 0 00-9-3.714" />
                        </svg>
                        <span
                            class="ml-3 whitespace-nowrap transition-all duration-300 overflow-hidden menu-item-transition"
                            :class="$store.sidebar.collapsed ? 'opacity-0 w-0' : 'opacity-100 w-auto'">
                    ...
                    <div>
                        <button type="button" @click="inventoryOpen = !inventoryOpen"
                            ...
                            <svg class="w-4 h-4 ml-auto flex-shrink-0 transform transition"
                                :class="inventoryOpen ? 'rotate-180' : ''" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 9l-7 7-7-7" />
                            </svg>
                        ...
                        <div x-show="inventoryOpen" x-collapse class="mt-1 space-y-1 overflow-hidden">
                            ...
                            <a href="{{ url('/inventory/po/approval') }}"
                                class="flex items-center pl-11 pr-3 py-2.5 rounded-lg text-gray-600 hover:bg-blue-50 hover:text-blue-600 transition-colors group"
                                :class="request()->is('po*') ? 'bg-blue-50 text-blue-600 font-medium' : ''">
                                <span
                                    class="whitespace-nowrap transition-all duration-300 overflow-hidden menu-item-transition"
                    ...
                    <div>
                        <button type="button" @click="financeOpen = !financeOpen"
                            ...
                            <svg class="w-4 h-4 ml-auto flex-shrink-0 transform transition"
                                :class="financeOpen ? 'rotate-180' : ''" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 9l-7 7-7-7" />
                            </svg>
                        ...
                        <div x-show="financeOpen" x-collapse class="mt-1 space-y-1 overflow-hidden">
                            ...
                            <a href="{{ url('/finance/payment_vouchers/approval') }}"
                                class="flex items-center pl-11 pr-3 py-2.5 rounded-lg text-gray-600 hover:bg-blue-50 hover:text-blue-600 transition-colors group"
                                :class="request()->is('grn*') ? 'bg-blue-50 text-blue-600 font-medium' : ''">
                                <span
                                    class="whitespace-nowrap transition-all duration-300 overflow-hidden menu-item-transition"
                    ...
                    <div>
                        <button type="button" @click="reportopen = !reportopen"
                            ...
                            <svg class="w-4 h-4 ml-auto flex-shrink-0 transform transition"
                                :class="reportopen ? 'rotate-180' : ''" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 9l-7 7-7-7" />
                            </svg>
                        ...
                        <div x-show="reportopen" x-collapse class="mt-1 space-y-1 overflow-hidden">
                            ...
                            <a href="{{ route('reports.customer-details') }}"
                                class="flex items-center pl-11 pr-3 py-2.5 rounded-lg text-gray-600 hover:bg-blue-50 hover:text-blue-600 transition-colors group"
                                :class="request()->is('reports/customer-details*') ? 'bg-blue-50 text-blue-600 font-medium' : ''">
                                <span
                                    class="whitespace-nowrap transition-all duration-300 overflow-hidden menu-item-transition"
                                    :class="$store.sidebar.collapsed ? 'opacity-0 w-0' : 'opacity-100 w-auto'">
                                    Customer Details
            ...
            <div class="border-t border-gray-100 p-4">
                <div class="flex items-center">
                    <div
                        class="h-8 w-8 rounded-full bg-gradient-to-r from-blue-500 to-indigo-600 flex items-center justify-center text-white font-medium text-sm flex-shrink-0">
        ...
        <div x-show="!$store.sidebar.collapsed" @click="$store.sidebar.collapsed = true"
            ...
            x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-100" x-cloak>
        </div>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            ...
                            <div
                                class="h-9 w-9 rounded-full bg-gradient-to-r from-blue-500 to-indigo-600 flex items-center justify-center text-white font-medium">
                                {{ substr(Auth::user()->name, 0, 1) }}
                            </div>
