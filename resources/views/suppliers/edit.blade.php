        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <div class="flex items-center gap-2 mt-1">
                    <span class="text-sm font-medium text-gray-600">{{ $supplier->name }}</span>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="px-6 py-5 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-gray-900">Update Supplier Information</h3>
                            <p class="text-sm text-gray-600">Modify the supplier details as needed</p>
                        </div>
                    </div>
                </div>
                ...
                <form method="POST" action="{{ url('/suppliers/'.$supplier->id) }}">
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                        <span class="text-sm text-gray-500 bg-gray-100 px-2 py-1 rounded">Read Only</span>
                                    </div>
                                </div>
                                <p class="text-xs text-gray-500">Unique identifier (cannot be modified)</p>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="name"
                                       ...
                                       required>
                                <p class="text-xs text-gray-500">Full legal name of the supplier company</p>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <input type="text" name="mobile"
                                           ...
                                           class="w-full px-4 py-3 pl-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors placeholder-gray-400"
                                ...
                                <p class="text-xs text-gray-500">Primary contact number with country code</p>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <p class="text-xs text-gray-500">Primary contact person at the supplier</p>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <p class="text-xs text-gray-500">Official email address for communication</p>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <p class="text-xs text-gray-500">Official VAT/Tax registration number</p>
                            </div>
                        </div>
                        ...
                        <div class="mt-6 space-y-2">
                            ...
                            <p class="text-xs text-gray-500">Complete business address for correspondence and delivery</p>
                        </div>
                        ...
                        <div class="mt-8 pt-6 border-t border-gray-200 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            ...
                            <div class="flex gap-3">
                                ...
                                <button type="submit"
                                        class="inline-flex items-center px-5 py-2.5 border border-transparent rounded-lg shadow-sm text-sm font-bold text-white bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
